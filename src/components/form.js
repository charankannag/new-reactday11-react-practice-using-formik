    ...
    <div className='book-container'>
      ...
      >
        {({ errors, touched }) => (
          ...
          <br/>  <div className='btndiv'>
            <button className='btn btn-primary' type="submit">{isEdit ? 'Update' : 'Submit'}</button>
            </div>
      ...
      <div className="tb">
       <h3 style={{textAlign:'center',color:'black'}}>VIEW BOOK DETAILS</h3>
